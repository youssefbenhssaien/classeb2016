...
window.CAR = {
        ...
        advantages: [
			...
			'🏙 Vous roulez en ville comme sur route 🛣️',
        ...
        detailsCards: [
			 ...
			 ========================= */
		  {
			...
			items: [
			  ...
			  { label: "Aide au démarrage en côte (HOLD)", value: "Oui", highlight: true },
			  { label: "Détection sous-gonflage", value: "Oui", highlight: true },
			  { label: "Fermeture centralisée", value: "Télécommandée", highlight: false },
			  { label: "Start/Stop", value: "Oui", highlight: true },
			],
		  },
			 ...
			 ========================= */
		  {
			...
			items: [
			  ...
			  { label: "Commandes au volant", value: "Oui", highlight: true },
			  { label: "Ordinateur de bord", value: "Oui", highlight: true },
			 ...
			 ========================= */
		  {
			...
			items: [
			  ...
			  { label: "Allumage automatique des feux", value: "Oui", highlight: true },
			],
		  },
			 ...
			 ========================= */
		  {
			...
			items: [
			  ...
			  { label: "Sellerie", value: "Tissu premium", highlight: true },
			 ...
			 ========================= */
		  {
			...
			items: [
			  ...
			  { label: "Carnet d'entretien", value: "Non", highlight: false },
			  { label: "Factures d'entretien", value: "Oui", highlight: true },
			],
		  },
		],
        images: {
